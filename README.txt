...
To run tiobot: docker run -p 443:443 -v /Users/jamessmith/tiobot-config.js:/usr/src/app/configuration/config.js:ro  --name=tiobot --link tiovulndb:mongo -it tiobot
